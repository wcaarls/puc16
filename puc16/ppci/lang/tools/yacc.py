...
class XaccGenerator:
    ...
    def generate_python_script(self):
        ...
        self.print("from puc16.ppci.lang.tools.grammar import Production, Grammar")
        self.print(
            "from puc16.ppci.lang.tools.lr import LrParser, Reduce, Shift, Accept"
        )
        self.print("from puc16.ppci.lang.common import Token")
        self.print("")
